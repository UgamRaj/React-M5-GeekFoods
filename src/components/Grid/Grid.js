const Card = () => {
  return (
    <>
      <div className="hero-third-card-Section">
        <div className="hero-card article1">
        ...
        <div className="hero-card article2">
          <p className="card-text">
        ...
        <div className="hero-card article3">
          <p className="card-text">
        ...
        <div className="hero-card article4">
          <p className="card-text">
        ...
        <div className="hero-card article5">
          <p className="card-text">
        ...
        <div className="hero-card article6">
          <p className="card-text">
